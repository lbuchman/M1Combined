...
type
  ...
  private
    ...
    procedure ExecuteTestWrapper(Sender: TObject; callback: TMethodPtr);
  public
    newData: string;
...
procedure TmainForm.ExecuteTestWrapper(Sender: TObject; callback: TMethodPtr);
begin
...
begin
  ExecuteTestWrapper(Sender, TMethodPtr(@FuncTestSwitchClick));
end;

procedure TmainForm.ICTTestSwitchClick_Wrapper(Sender: TObject);
begin
  ExecuteTestWrapper(Sender, TMethodPtr(@ICTTestSwitchClick));
end;

procedure TmainForm.AppsCheckSwitchClick_Wrapper(Sender: TObject);
begin
  ExecuteTestWrapper(Sender, TMethodPtr(@AppsCheckSwitchClick));
end;
...
begin
  ExecuteTestWrapper(Sender, TMethodPtr(@EEPROMSwitchClick));
end;

procedure TmainForm.MacProgSwitchClick_Wrapper(Sender: TObject);
begin
  ExecuteTestWrapper(Sender, TMethodPtr(@MacProgSwitchClick));
end;

procedure TmainForm.DoLabelSwitchClick_Wrapper(Sender: TObject);
begin
  ExecuteTestWrapper(Sender, TMethodPtr(@DoLabelSwitchClick));
end;
