...
/* Definitions of data related to this example */
  ...
  /*       defined below).                                                    */
  #define ADC_AWD_THRESHOLD_HIGH           (__LL_ADC_DIGITAL_SCALE(LL_ADC_RESOLUTION_12B) * 5 /8) /* Analog watchdog threshold high: 5/8 of full range (4095 <=> Vdda=2.9V): 2559 <=> 2.06V */
  #define ADC_AWD_THRESHOLD_LOW            (__LL_ADC_DIGITAL_SCALE(LL_ADC_RESOLUTION_12B) * 1 /8) /* Analog watchdog threshold low: 1/8 of full range (4095 <=> Vdda=2.9V): 512 <=> 0.41V */
...
__STATIC_INLINE void Configure_ADC(void)
{
  ...
  /*                    5/8 of full range (4095 <=> Vdda=2.9V): 2559<=> 1.81V */
  /*  - Low threshold:  between DAC steps 0 and 1/4 of full range:              */
  /*                    1/8 of full range (4095 <=> Vdda=2.9V): 511 <=> 0.36V */
