...
In this example:
    - CPU2(Cortex-M4) turns on the LED4. the LED4 is fixed ON until OpenAMP middleware is initialized.
...
@par Hardware and Software environment
  ...
  - This example has been tested with STM32MP157F-EV1 board and can be
