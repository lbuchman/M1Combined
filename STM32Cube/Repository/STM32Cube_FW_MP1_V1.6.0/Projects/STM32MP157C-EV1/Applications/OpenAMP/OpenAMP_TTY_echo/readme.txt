...
In this example:
    - CPU2(CM4) turns on the LED4. the LED4 is fixed ON until OpenAMP middleware is initialized.
    - CPU2(CM4) initializes OpenAMP MW which initializes/configures IPCC peripheral through HAL
    ...
    - LED4 toggles when the RPMsg communication is initialised.
