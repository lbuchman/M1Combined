...
procedure TDoor1Form.SaveGeometry();
begin
  setFormGeometryJson('reader1Form', top, left, Width, Height);
end;

procedure TDoor1Form.FormShow(Sender: TObject);
var
...
begin
  ...
  _width := 0;
  _height := 0;
  getFormGeometryJson('reader1Form', _top,
...
procedure TDoor1Form.KeypadKeyClick(Sender: TObject);
begin
  MainAppForm.SendCommand('keypadpress', IntToStr(DoorNumber) +
    ' ' + IntToStr(TButton(Sender).Tag));
end;

procedure TDoor1Form.ReaderpropReadButtonClick(Sender: TObject);
begin
...
procedure TDoor1Form.ReaderpropSaveButtonClick(Sender: TObject);
begin
  MainAppForm.SendCommand('saveconfig', 'null');
end;


procedure TDoor1Form.ReaderpropWriteButtonClick(Sender: TObject);
var
  cmd, arg: string;
begin
  cmd := 'setreaderconfig';
...
procedure TDoor1Form.RexSensorModeComboChange(Sender: TObject);
begin

end;

procedure TDoor1Form.ShortImageDoorClick(Sender: TObject);
begin
  MainAppForm.SendCommand('setsupervisedinput', IntToStr(DS_Number) + ' 2');
end;

procedure TDoor1Form.CutImageDoorClick(Sender: TObject);
begin
  MainAppForm.SendCommand('setsupervisedinput', IntToStr(DS_Number) + ' 3');
end;

procedure TDoor1Form.OpenDoorClick(Sender: TObject);
begin
  MainAppForm.SendCommand('setsupervisedinput', IntToStr(DS_Number) + ' 1');
end;

procedure TDoor1Form.Reader1DblClick(Sender: TObject);
begin
...
procedure TDoor1Form.ShortImageRexClick(Sender: TObject);
begin
  MainAppForm.SendCommand('setsupervisedinput', IntToStr(Rex_Number) + ' 2');
end;

procedure TDoor1Form.StrikeDefaultStateComboChange(Sender: TObject);
begin

end;

procedure TDoor1Form.Timer1Timer(Sender: TObject);
var
  retStatus: boolean;
begin
...
procedure TDoor1Form.RexSensorDblClick(Sender: TObject);
begin
...
procedure TDoor1Form.ClosedDoorClick(Sender: TObject);
begin
  MainAppForm.SendCommand('setsupervisedinput', IntToStr(DS_Number) + ' 0');
end;

procedure TDoor1Form.CutImageRexClick(Sender: TObject);
begin
  MainAppForm.SendCommand('setsupervisedinput', IntToStr(Rex_Number) + ' 3');
end;

procedure TDoor1Form.FormCreate(Sender: TObject);
begin
  Caption := 'Door ' + IntToStr(DoorNumber);
end;

procedure TDoor1Form.updateData(var jData: TJSONData; cmd: string);
var
  readerId: integer;
begin
