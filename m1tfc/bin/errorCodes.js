...
const errorCodes = {
    ...
    EEPROMUPDATE: { errorCode: '00UPD-0EEPROM', test: 'ICT', desc: 'Update EEPROM data failed' },
    ...
    PEN_DRIVE: { errorCode: '00000PEN_DRIVE', test: 'FUNC', desc: 'Pen drive failed. UUT USB Host issue' },
