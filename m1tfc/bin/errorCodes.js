...
const errorCodes = {
    ...
    'J5.26': { errorCode: '000000TPJ5.26', test: 'ICT', desc: 'voltage is out of tolerance' },
    ...
    EEPROMUPDATE: { errorCode: '00UPD-0EEPROM', test: 'ICT', desc: 'Update EEPROM data failed, the issue could be DFU and the PC test' },
    BATOP: { errorCode: '00BATT-SWITCH', test: 'ICT', desc: 'Test Main power to battery power switching failed' },
    BACHR: { errorCode: '000BATT-CHARG', test: 'ICT', desc: 'battery module charging voltage is out of tolerance' },
    ...
    MAC_CMP_ERR: { errorCode: '000MAC_CMP_ERR', test: 'FUNC', desc: 'OS reported MAC does not match OTP MAC' },
    ...
    SSH_RECON: { errorCode: '0000SSH_RECON', test: 'FUNC', desc: 'ssh connection to UUT error, see logs' },
    DFU_STM: { errorCode: '000000DFU_STM', test: 'FUNC', desc: 'Program bootstrap STM file over DFU error' },
