...
if [ "$teensyType" = "teensy4" ]; then
    ...
    if [ "$teensyVersion" = 0 ]; then
        ...
        mv main.a ${ARDUINO_INST}/hardware/tools/arm/arm-none-eabi/lib/armv7e-m/fpu/fpv5-d16/libteensy4${2}.a
        exit 0
    fi
    ...
    set +e
    cp ${COREPATH}/main.cpp.orig ${COREPATH}/main.cpp 2>/dev/null
